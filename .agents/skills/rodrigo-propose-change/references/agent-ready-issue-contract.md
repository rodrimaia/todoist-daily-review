...
Design every approved slice so proposal publication can create a complete issue for a fresh Ralph Worker. The issue is a source-linked Generated Projection, never a normative source.
